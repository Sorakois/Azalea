        ...
        if game == "HSR":
            ...
            try:
                ...
                try:
                    ...
                    #Unreleased
                    elif character.lower() in ["saber", "phainon", "archer"]:
                        em.set_image(url=f"https://starrail.honeyhunterworld.com/img/character/{character.lower()}-character_cut_in_front.webp")
